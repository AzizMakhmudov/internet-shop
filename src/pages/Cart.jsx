      ...
      {modal && (
        <div className="popup">
          <div className="popup-inner">
            <p style={{ marginBottom: '20px', fontSize: '20px', fontWeight: '600' }}>{`$${calculateTotal()}`}</p>
              ...
              <div className="form-box">
                <form data-netlify="true">
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
                    <input required placeholder='First Name' type="text" style={{ border: '1px solid #a3a3a3' }} />
                    <input required placeholder='Last Name' type="text" style={{ border: '1px solid #a3a3a3' }} />
                  </div>
                  <input required type="email" placeholder='Email' style={{ width: '100%', marginBottom: '10px', border: '1px solid #a3a3a3' }} />
                  <input required type='number' placeholder='Phone' style={{ width: '100%', marginBottom: '10px', border: '1px solid #a3a3a3' }} />
                  <input required type='number' placeholder='Card Number' style={{ width: '100%', border: '1px solid #a3a3a3', }} />
                  <div style={{ marginBottom: '10px' }}>
                    <input required style={{ width: '50%', border: '1px solid #a3a3a3' }} type="number" placeholder='Expiry Date' />
                    <input required style={{ width: '50%', border: '1px solid #a3a3a3' }} type="number" placeholder='CVC' />
                  </div>
                  <p style={{ marginBottom: '10px' }}>Address</p>
                  <select required style={{ border: '1px solid #a3a3a3', marginBottom: '10px', width: '100%', padding: '10px 10px', cursor: 'pointer', appearance: 'none' }}>
                  ...
                  <input required type="text" placeholder='ZIP Code' style={{ marginBottom: '10px', width: '100%', border: '1px solid #a3a3a3' }} />
